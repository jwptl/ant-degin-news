<template>
  <div class="container">
    ...
    <div class="cont-body">
      <div class="leftMenu">
        <LeftMenu @handleOk="handleOk" />
      </div>
      <div class="rightCont">
        <div class="contlist">
          <ContentList :newList = "newList"/>
        </div>
        <div class="aboutlist">
          <div class="search-box">
            <a-input default-value="今日热点" placeholder="请输入热点">
            ...
            <div class="pane-module">
              ...
              <ul class="links-wrapper">
                ...
                <li class="item">
                  <a
                    target="_blank"
                    href="http://www.stardaily.com.cn/"
                    rel="noopener noreferrer"
                    >北京娱乐信报</a
                  >
                </li>
                ...
                <li class="item">
                  <a
                    target="_blank"
                    href="https://www.dcdapp.com/?zt=tt_pc_friendly_link"
                    rel="noopener noreferrer"
                    >懂车帝</a
                  >
                </li>
                <li class="item">
                  <a
                    target="_blank"
                    href="https://www.autohome.com.cn/"
                    rel="noopener noreferrer"
                    >汽车之家</a
                  >
                </li>
          ...
          <div class="company">
            <div class="company-wrapper">
              ...
              <p>
                <a rel="noopener noreferrer">网络谣言曝光台</a>
              </p>
              <a rel="noopener noreferrer">中国互联网举报中心</a
              ><a h rel="noopener noreferrer">&nbsp;京ICP证140141号</a>
              <div>
                <a rel="noopener noreferrer">京ICP备12025439号-3</a
                ><a class="icp" rel="noopener noreferrer"
                  >&nbsp;网络文化经营许可证</a
                >
              </div>
              <a rel="noopener noreferrer">营业执照</a>
              <p>京-非经营性-2016-0081</p>
              <p>互联网药品信息服务资格证书</p>
              <p>
                <a rel="noopener noreferrer">跟帖评论自律管理承诺书</a>
              </p>
...
import { getNewsIdListCms } from "@/api/system/newsList";
export default {
  components: {
    LeftMenu,
    ContentList,
  ...
  methods: {
    async getList(id) {
      const res = await getNewsIdListCms({
        id: id,
      });
