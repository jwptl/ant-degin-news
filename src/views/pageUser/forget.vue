<template>
  <div class="container">
    <div class="cont-box">
      <div class="cont-title">信息管理后台-忘记密码</div>
      <div class="cont-form">
        <a-form :form="form">
        ...
        <div class="confirm-btn">
          <a-button type="primary" @click="sign()"> 确定 </a-button>
        </div>
        <div class="tips" >
...
<script>
import { forgetCms, getCodeCms } from "@/api/system/login";
export default {
  data() {
    return {
      form: {
  ...
  methods: {
    async sign() {
      ...
      const res = await forgetCms(this.form);
